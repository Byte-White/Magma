...
namespace mg
{
	...
	/*
	* Uses Crimson Shadow Theme by default
	* https://gist.github.com/Byte-White/63557f5ea49f956c2b7edc5f622f72cc
	* And FiraCode Font(SIL Open Font License (OFL))
	*/
	void RenderAPI::SetupTheme()
	{
		// Color Theme
		CrimsonShadowTheme();
		// DarkForestTheme();
